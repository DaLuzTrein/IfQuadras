...
<body>
        ...
        <div class="container1">
            <div class="container2">
                ...
                <form action="../php/exec_cadastroQuadra.php" method="post" enctype="multipart/form-data">
                ...
                <input type = "text" name="nomeQuadra" id="nomeQuadra" size="50"><br>
                <label> Material <label><br>
                <input type = "text" name="tipoMaterial" id="tipoMaterial" size="50"><br>
                <label> Esporte <label><br>
                <input type = "text" name="esporte" id="esporte" size="50"><br>
                <label> Preço <label><br>
                <input type="number" name="precoQuadra" id="precoQuadra" step="0.01" min="0" inputmode="decimal" placeholder="0.00"><br> <br>
                <?php
                ...
                <button class="gremio">Enviar</button> <br> 
                     ...
                     <button type="button" onclick="window.location.href='../php/administrarQuadras.php'" class="inter"> Voltar </button> 
                </div>
            </div>
        </div>
</body>
